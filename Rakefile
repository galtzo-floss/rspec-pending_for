...
# rspec-pending_for Rakefile v7.1.14 - 2026-09-01
...
# rake install                                # Build and install rspec-pending_for-1.0.0.gem in...
# rake install:local                          # Build and install rspec-pending_for-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template rspec-pending_for against itse...

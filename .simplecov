# kettle-jem:freeze
# To retain chunks of comments & code during rspec-pending_for templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# rspec-pending_for will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
